...
# TODO
ALLOWED_HOSTS = ['localhost', 'websocket_server', 'pong-service', 'users-service', os.getenv("HOST_IP"), '10.11.3.7:8443', '127.0.0.1:8443']
...
# usage:
# import logging
# logger = logging.getLogger("pong_logger")
