...
function createTournamentUserWebSocket() {
    ...
    g_tournamentUserWebSocket.onopen = function (e) {
        console.log("Pong WS: Opened tournament websocket connection.");
    }
    
    g_tournamentUserWebSocket.onclose = function (e) {
        console.log("Pong WS: Closed tournament websocket connection.");
    }
        ...
        try {
            ...
            if (data.type)
                ...
                if (data.type === "joined_tournament")
                {
                    ...
                    // createPongGameWebSocket(tournament_id, user_token);
                }
                else {
